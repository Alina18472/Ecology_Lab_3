...
def pend(x, C, faks, f, xm, t=0.0, power=0.55):
    ...
    norm_sum_pos = min(1.0, (sum_pos / 10.0) ** power)
    norm_sum_neg = min(1.0, (sum_neg / 4.0) ** power)
    ...
    norm_sum_pos2 = min(1.0, (sum_pos2 / 5.0) ** power)
    norm_sum_neg2 = min(1.0, (sum_neg2 / 4.0) ** power)
    ...
    norm_sum_pos3 = min(1.0, (sum_pos3 / 9.0) ** power)
    norm_sum_neg3 = min(1.0, (sum_neg3 / 4.0) ** power)
